...
<head>
    <title>Code coverage report for src/dto/request/TopupRequest.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/dto/request</a> TopupRequest.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Phone } from "../response/Phone";
&nbsp;
export abstract class TopupRequest {
&nbsp;
    /**
...
&nbsp;
    constructor(amount: number, operatorId: number,
        useLocalAmount: boolean, senderPhone: Phone, customIdentifier?: string) {
        this.amount = amount;
