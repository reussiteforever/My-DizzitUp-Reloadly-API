...
<head>
    <title>Code coverage report for src/filter/OperatorFilter.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/filter</a> OperatorFilter.ts</h1>
        <div class='clearfix'>
...
&nbsp;
    public <span class="fstat-no" title="function not covered" >OperatorFilter(</span>) {
<span class="cstat-no" title="statement not covered" >        this.parameters[OperatorFilter.INCLUDE_PIN] = true;</span>
<span class="cstat-no" title="statement not covered" >        this.parameters[OperatorFilter.INCLUDE_DATA] = true;</span>
<span class="cstat-no" title="statement not covered" >        this.parameters[OperatorFilter.INCLUDE_BUNDLES] = true;</span>
<span class="cstat-no" title="statement not covered" >        this.parameters[OperatorFilter.INCLUDE_SUGGESTED_AMOUNTS] = false;</span>
<span class="cstat-no" title="statement not covered" >        this.parameters[OperatorFilter.INCLUDE_SUGGESTED_AMOUNTS_MAP] = false;</span>
<span class="cstat-no" title="statement not covered" >        this.parameters[OperatorFilter.INCLUDE_RANGE_DENOMINATION_TYPE] = true;</span>
<span class="cstat-no" title="statement not covered" >        this.parameters[OperatorFilter.INCLUDE_FIXED_DENOMINATION_TYPE] = true;</span>
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    withPage(</span>pageNumber: number, pageSize: number): OperatorFilter {
<span class="cstat-no" title="statement not covered" >        super.withPage(pageNumber, pageSize);</span>
