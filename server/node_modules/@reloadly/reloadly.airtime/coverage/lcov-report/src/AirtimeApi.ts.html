...
<head>
    <title>Code coverage report for src/AirtimeApi.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> AirtimeApi.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">17x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import ReloadlyAuthentication = require("@reloadly/reloadly.authentication");
...
&nbsp;
    constructor(
        clientId: string = <span class="branch-0 cbranch-no" title="branch not covered" >null,</span> clientSecret: string = <span class="branch-0 cbranch-no" title="branch not covered" >null,</span> accessToken: string = null,
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    async </span>refreshAccessToken&lt;T&gt;(request: ReloadlyCore.IRequest&lt;T&gt;) {
<span class="cstat-no" title="statement not covered" >        this.accessToken = null;</span>
        const customizableRequest: ReloadlyCore.ICustomizableRequest&lt;T&gt; = &lt;ReloadlyCore.ICustomizableRequest&lt;T&gt;&gt;<span class="cstat-no" title="statement not covered" >request;</span>
        const newAccessToken: string = <span class="cstat-no" title="statement not covered" >await this.retrieveAccessToken();</span>
<span class="cstat-no" title="statement not covered" >        customizableRequest.addHeader(ReloadlyCore.HttpHeader.AUTHORIZATION, "Bearer " + newAccessToken);</span>
    }
&nbsp;
...
&nbsp;
    private getServiceByEnvironment(environment: ReloadlyCore.Environment): ReloadlyCore.Service {
        return (environment == ReloadlyCore.Environment.LIVE) ? <span class="branch-0 cbranch-no" title="branch not covered" >ReloadlyCore.Service.AIRTIME </span>: ReloadlyCore.Service.AIRTIME_SANDBOX;
    }
&nbsp;
    private async retrieveAccessToken(): Promise&lt;string&gt; {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.cacheAccessToken) {
...
&nbsp;
    private async doGetAccessToken(service: ReloadlyCore.Service): Promise&lt;string&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.accessToken) {
<span class="cstat-no" title="statement not covered" >            return this.accessToken;</span>
        };
&nbsp;
        var authApi =
