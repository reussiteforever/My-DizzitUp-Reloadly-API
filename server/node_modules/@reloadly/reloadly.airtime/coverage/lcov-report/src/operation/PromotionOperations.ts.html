...
<head>
    <title>Code coverage report for src/operation/PromotionOperations.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/operation</a> PromotionOperations.ts</h1>
        <div class='clearfix'>
...
&nbsp;
    public getByCountryCode(countryCode: string): ReloadlyCore.IRequest&lt;Promotion[]&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!countryCode) throw new Error("'c<span class="cstat-no" title="statement not covered" >ountryCode' must be provided.");</span>
