...
<head>
    <title>Code coverage report for src/operation/TransactionHistoryOperations.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/operation</a> TransactionHistoryOperations.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-no">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import ReloadlyCore = require("@reloadly/reloadly.core");
...
<span class="cstat-no" title="statement not covered" ><span class="missing-if-branch" title="if path not taken" >I</span></span>
    private validateStartAndEndDate(filter?: TransactionHistoryFilter) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>    throw new Error("The start date must NOT be greater than the end date");
