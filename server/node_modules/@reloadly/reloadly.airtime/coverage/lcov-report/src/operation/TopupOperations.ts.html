...
<head>
    <title>Code coverage report for src/operation/TopupOperations.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/operation</a> TopupOperations.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import ReloadlyCore = require("@reloadly/reloadly.core");
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if ("recipientPhone" in request) {<span class="cstat-no" title="statement not covered" ></span>
        <span class="missing-if-branch" title="if path not taken" >I</span>    this.assertValidPhone((&lt;PhoneTopupRequest&gt;reque<span class="cstat-no" title="statement not covered" >st).recipientPhone, "recipientPhone");</span>
        } else if ("recipientEmail" in request) {
        <span class="missing-if-branch" title="else path not taken" >E</span>    this.assertValidEmail((&lt;EmailTopupRequest&gt;request).recipientEmail);
        }
...
&nbsp;
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>    messagePrefix3 = "Recipient phone country code";
        } else if (fieldName &amp;&amp; fieldName.toLowerCase() == "senderphone") {
            messagePrefix1 = "Sender phone";
            messagePrefix2 = "Sender phone number";
            mes<span class="cstat-no" title="statement not covered" >sagePrefix3 = "Sender phone country code";</span>
        }<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" ></span>
        if (<span class="cstat-no" title="statement not covered" >!phone || !phone.number) throw new Error("'pho</span>ne.number' must be provided.");
&nbsp;
        const number = phone.number.replace("+", "").replace(" ", "").trim();
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!(number.length &gt; 3 &amp;&amp; /[<span class="cstat-no" title="statement not covered" >0-9]+/.test(number))) {</span>
...
<span class="missing-if-branch" title="if path not taken" >I</span>
        if (<span class="cstat-no" title="statement not covered" >!phone.countryCode) throw new Error(messagePrefix3 + " must be provided.");</span>
    }
&nbsp;
    priv<span class="missing-if-branch" title="if path not taken" >I</span>ate assertValidEmail(ema<span class="cstat-no" title="statement not covered" >il) {</span>
        const re = /^(([^&lt;&gt;()[\]\\.,;:\s@"]+(\.[^&lt;&gt;()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
        if (!re.test(String(email).toLowerCase())) {
<span class="fstat-no" title="function not covered" >            throw new Error("</span>Invalid email.");
        }<span class="cstat-no" title="statement not covered" ></span>
    }<span class="cstat-no" title="statement not covered" ></span>
}<span class="cstat-no" title="statement not covered" ></span>
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Wed Jul 21 2021 09:29:20 GMT+0100 (British Summer Time)
            </div>
        </div>
