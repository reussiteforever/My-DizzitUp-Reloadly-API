...
<head>
    <title>Code coverage report for src/operation/OperatorOperations.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/operation</a> OperatorOperations.ts</h1>
        <div class='clearfix'>
...
&nbsp;
    publ<span class="missing-if-branch" title="if path not taken" >I</span>ic calculateFxRate<span class="cstat-no" title="statement not covered" >(operatorId: bigint, amount: number): ReloadlyCore.</span>IRequest&lt;OperatorFxRate&gt; {
        this.validateOperatorId(operatorId);
...
&nbsp;
    validatePhoneAndCountryCode(phone: string, countryCode: string) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!countryCode) throw new Error("<span class="cstat-no" title="statement not covered" >'countryCode' was not provided.");</span>
    }
}
&nbsp;</pre></td></tr></table></pre>
