...
<head>
    <title>Code coverage report for src/operation/BaseAirtimeOperation.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/operation</a> BaseAirtimeOperation.ts</h1>
        <div class='clearfix'>
...
&nbsp;
        var qs = url.indexOf("?") == -1 ? "?" : <span class="branch-1 cbranch-no" title="branch not covered" >"";</span>
        if (filter) {
